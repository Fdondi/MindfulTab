(function () {
  ...
  root.id = "mindfultab-pause-bird-root";

  const bubble = document.createElement("div");
  bubble.className = "mindfultab-pause-bubble";
  bubble.textContent = "PAUSE!";

  const svgWrap = document.createElement("div");
  svgWrap.className = "mindfultab-pause-bird-svg";
  svgWrap.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="72" height="72">
    <path fill="#5D4037" d="M14,46C18,42 24,40 32,40C40,40 46,42 50,46L48,50C44,47 38.7,45.7 32,45.7C25.3,45.7 20,47 16,50Z"/>
    <path fill="#86EFAC" d="M31.5,18C38.4,18 44,23.6 44,30.5C44,37.4 38.4,43 31.5,43C24.6,43 19,37.4 19,30.5C19,23.6 24.6,18 31.5,18Z"/>
  ...
  window.__mindfultabPauseBirdTeardown = function () {
    try {
      root.remove();
    } catch (_) {}
    delete window.__mindfultabPauseBirdTeardown;
  };
})();
